...
class NovaTempestStaging(base.BaseNovaTempestStaging):

    @classmethod
    def setup_clients(cls):
        super(NovaTempestStaging, cls).setup_clients()
        cls.client = cls.servers_client

    def tearDown(self):
        self.clear_servers()
        super(NovaTempestStaging, self).tearDown()
    ...
    def resource_cleanup(cls):
        super(NovaTempestStaging, cls).resource_cleanup()
